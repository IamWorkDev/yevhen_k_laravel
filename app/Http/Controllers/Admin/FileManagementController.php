...
class FileManagementController extends Controller
{
    ...
    /**
     * Get file to download user
     *
     * @link /admin_panel/file/{id}/download
     * @method GET
     *
     * @param $id
     ...
     * Remove File
     *
     * @link /admin_panel/file/{id}/remove
     * @method GET
     *
     * @param $id
    ...
    /**
     * Get view for edit file
     *
     * @link /admin_panel/file/{id}/edit
     * @method GET
     *
     * @param $id
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View
     ...
     * Save update of file
     *
     * @link /admin_panel/file/{id}/update
     * @method GET
     *
